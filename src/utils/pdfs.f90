...
contains
    ...
    !#
    !########################################################################
    subroutine PDF1V2D(ilim, nx, ny, nz, k, umin_ext, umax_ext, u, nbins, pdf, wrk1d, a, avg)
...
#define vmax(ib)   wrk2d(ib,2)
#define vstep(ib)  wrk2d(ib,3)
...
#undef vstep
    ...
    !########################################################################
    subroutine PDF_ANALYZE(ibc, nbins, pdf, umin_ext, umax_ext, plim, nplim)
